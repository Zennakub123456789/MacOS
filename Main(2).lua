...
function MacUI:Window(config)
    ...
    local Themes = {
        Default = {
            ...
            TextInactive = Color3.fromRGB(100, 100, 105),
            TextActive = Color3.fromRGB(255, 255, 255),
            TabStrokeInactive = Color3.fromRGB(235, 235, 240),
    ...
    function self:Tab(name, icon)
        ...
        -- อัปเดต CanvasSize อัตโนมัติเมื่อมีการเปลี่ยนแปลงเนื้อหา
