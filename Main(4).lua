...
function MacUI:Window(config)
    ...
    create("UIStroke", {
        ...
        Color = Color3.fromRGB(209, 209, 214),
        Thickness = 1,
        Transparency = 0.5
    })
    ...
    local SearchIcon = create("ImageLabel", {
        ...
        ImageColor3 = Color3.fromRGB(142, 142, 147)
    })
    ...
    local SearchBox = create("TextBox", {
        ...
        PlaceholderColor3 = Color3.fromRGB(174, 174, 178),
        Text = "",
    ...
    SearchBox:GetPropertyChangedSignal("Text"):Connect(function()
        ...
        for _, tab in ipairs(self.Tabs) do
            if tab.Button and tab.Name then
        ...
        for _, divider in ipairs(self.Dividers) do
            if divider.Text and divider.Frame then
                if searchText == "" or divider.Text:lower():find(searchText) then
                    divider.Frame.Visible = true
                else
                    divider.Frame.Visible = false
                end
            end
        end
    end)
    ...
    function self:AddDivider(text)
        local dividerFrame = create("Frame", {
            Parent = TabButtons,
            Size = UDim2.new(1, -16, 0, 24),
            BackgroundTransparency = 1,
            LayoutOrder = #self.Tabs + #self.Dividers
        })
        ...
        local dividerText = create("TextLabel", {
            ...
            TextColor3 = currentTheme.TextSecondary or Color3.fromRGB(142, 142, 147),
            Font = Enum.Font.GothamBold,
            TextSize = 11,
            TextXAlignment = Enum.TextXAlignment.Left,
...
local function roundValue(val)
    ...
    function self:TempNotify(text1, text2, icon)
        ...
        local tempnotif = create("Frame", {
            Name = "tempnotif",
            Parent = ScreenGui,
            AnchorPoint = Vector2.new(0.5, 0.5),
            BackgroundColor3 = currentTheme.Background,
            BackgroundTransparency = 0.15,
            Position = UDim2.new(1, -250, 0.08, 0),
            Size = UDim2.new(0, 447, 0, 117),
            Visible = true,
            ZIndex = 10
        })
        create("UICorner", { Parent = tempnotif, CornerRadius = UDim.new(0, 14) })
        
        local t2 = create("TextLabel", {
            Name = "t2",
            Parent = tempnotif,
            BackgroundTransparency = 1,
            Position = UDim2.new(0.24, 0, 0.47, 0),
        ...
        if icon then
            local ticon = create("ImageLabel", {
                ...
                Parent = tempnotif,
                BackgroundTransparency = 1,
                Position = UDim2.new(0.03, 0, 0.19, 0),
    ...
    function self:Notify(title, text, buttonText, icon, callback)
        ...
        create("UICorner", { Parent = darkness, CornerRadius = UDim.new(0, 14) })
        ...
        if icon then
            local notifIcon = create("ImageLabel", {
                ...
                Parent = notifFrame,
                BackgroundTransparency = 1,
                Position = UDim2.new(0.34, 0, 0.1, 0),
        ...
        local notifTitle = create("TextLabel", {
            ...
            Parent = notifFrame,
            BackgroundTransparency = 1,
            Position = UDim2.new(0.17, 0, 0.38, 0),
        ...
        local notifText = create("TextLabel", {
            ...
            Parent = notifFrame,
            BackgroundTransparency = 1,
            Position = UDim2.new(0.08, 0, 0.51, 0),
        ...
        local notifButton = create("TextButton", {
            ...
            Parent = notifFrame,
            BackgroundColor3 = Color3.fromRGB(10, 132, 255),
            Position = UDim2.new(0.056, 0, 0.82, 0),
            Size = UDim2.new(0, 270, 0, 50),
            ZIndex = 20,
            Font = Enum.Font.GothamMedium,
            Text = buttonText or "OK",
            TextColor3 = Color3.fromRGB(255, 255, 255),
            TextSize = 18,
            AutoButtonColor = false
        })
        create("UICorner", { Parent = notifButton, CornerRadius = UDim.new(0, 9) })
        ...
        notifButton.MouseEnter:Connect(function()
            tween(notifButton, 0.15, { BackgroundColor3 = Color3.fromRGB(0, 122, 245) })
        end)
        
        notifButton.MouseLeave:Connect(function()
            tween(notifButton, 0.15, { BackgroundColor3 = Color3.fromRGB(10, 132, 255) })
        end)
    end

    function self:Notify2(title, text, button1Text, button2Text, icon, callback1, callback2)
        local notifFrame = create("Frame", {
            Name = "notif2",
            Parent = MainFrame,
            AnchorPoint = Vector2.new(0.5, 0.5),
        ...
        local notifButton1 = create("TextButton", {
            Name = "notifbutton1",
            Parent = notifFrame,
            BackgroundColor3 = Color3.fromRGB(10, 132, 255),
            Position = UDim2.new(0.056, 0, 0.72, 0),
            Size = UDim2.new(0, 270, 0, 40),
            ZIndex = 20,
            Font = Enum.Font.GothamMedium,
            Text = button1Text or "Sure!",
            TextColor3 = Color3.fromRGB(255, 255, 255),
            TextSize = 18,
            AutoButtonColor = false
        })
        create("UICorner", { Parent = notifButton1, CornerRadius = UDim.new(0, 9) })
        
        local notifButton2 = create("TextButton", {
            Name = "notifbutton2",
            Parent = notifFrame,
            BackgroundColor3 = Color3.fromRGB(240, 240, 245),
            BackgroundTransparency = 0,
            Position = UDim2.new(0.053, 0, 0.84, 0),
            Size = UDim2.new(0, 270, 0, 40),
            ZIndex = 20,
            Font = Enum.Font.GothamMedium,
            Text = button2Text or "Cancel",
            TextColor3 = currentTheme.Text,
            TextSize = 18,
            AutoButtonColor = false
        })
        create("UICorner", { Parent = notifButton2, CornerRadius = UDim.new(0, 9) })
        
        notifButton1.MouseButton1Click:Connect(function()
            if callback1 then
                callback1()
            end
            notifFrame:Destroy()
        ...
        notifButton2.MouseButton1Click:Connect(function()
            if callback2 then
                callback2()
            end
            notifFrame:Destroy()
        ...
        notifButton1.MouseEnter:Connect(function()
            tween(notifButton1, 0.15, { BackgroundColor3 = Color3.fromRGB(0, 122, 245) })
        end)
        
        notifButton1.MouseLeave:Connect(function()
            tween(notifButton1, 0.15, { BackgroundColor3 = Color3.fromRGB(10, 132, 255) })
        end)
        
        notifButton2.MouseEnter:Connect(function()
            tween(notifButton2, 0.15, { BackgroundColor3 = Color3.fromRGB(230, 230, 235) })
        end)
        
        notifButton2.MouseLeave:Connect(function()
            tween(notifButton2, 0.15, { BackgroundColor3 = Color3.fromRGB(240, 240, 245) })
        end)
    end

    function self:GreenButton(callback)
        if self._greenButtonConnection then
            self._greenButtonConnection:Disconnect()
        end
        
        self._greenButtonConnection = MaximizeButton.MouseButton1Click:Connect(function()
            if callback then
                callback()
            end
        end)
