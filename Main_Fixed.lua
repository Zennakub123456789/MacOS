...
local function roundValue(val)
    ...
    function self:EditOpenButton(settings)
        settings = settings or {}
        
        local isMobile = UserInputService.TouchEnabled and not UserInputService.MouseEnabled
        
        if settings.OnlyMobile and not isMobile then
            return
        end
        
        local existingButton = ScreenGui:FindFirstChild("MacUI_OpenButton")
        ...
        local lucideIcons = {
            monitor = "rbxassetid://10734896206",
            home = "rbxassetid://10723434711",
            settings = "rbxassetid://10734950309",
            menu = "rbxassetid://10723407389",
            star = "rbxassetid://10734896629",
            heart = "rbxassetid://10723343733",
            user = "rbxassetid://10734896rama",
            box = "rbxassetid://10723150121"
        }
        
        local iconImage = settings.Icon and lucideIcons[settings.Icon:lower()] or lucideIcons.monitor
        
        local OpenButton = create("TextButton", {
            Parent = ScreenGui,
            Name = "MacUI_OpenButton",
        ...
        local corner = create("UICorner", {
            Parent = OpenButton,
            CornerRadius = settings.CornerRadius or UDim.new(0, 16)
        })
        
        local stroke = create("UIStroke", {
            Parent = OpenButton,
            Thickness = settings.StrokeThickness or 2,
            Color = Color3.fromRGB(200, 200, 205),
            Transparency = 0.3,
            ApplyStrokeMode = Enum.ApplyStrokeMode.Border
        })
        ...
        local titleLabel = create("TextLabel", {
            ...
            BackgroundTransparency = 1,
            Text = settings.Title or "Open Menu",
            TextColor3 = Color3.fromRGB(255, 255, 255),
            Font = Enum.Font.GothamMedium,
            TextSize = 14,
            TextXAlignment = Enum.TextXAlignment.Left,
        ...
        OpenButton.MouseButton1Click:Connect(function()
            ...
            if isUIVisible then
                tween(OpenButton, 0.3, { 
                    Size = UDim2.new(0, 0, 0, 0),
                    Position = UDim2.new(0, 20 + 60, 0, 20 + 22)
                })
                task.wait(0.3)
                ...
                OpenButton.Position = UDim2.new(0, 20 + 60, 0, 20 + 22)
                tween(OpenButton, 0.3, { 
                    Size = UDim2.new(0, 120, 0, 44),
                    Position = UDim2.new(0, 20, 0, 20)
                })
        ...
        OpenButton.MouseEnter:Connect(function()
            tween(OpenButton, 0.2, { Size = UDim2.new(0, 124, 0, 46) })
            tween(stroke, 0.2, { Transparency = 0 })
        end)
        
        OpenButton.MouseLeave:Connect(function()
            tween(OpenButton, 0.2, { Size = UDim2.new(0, 120, 0, 44) })
        ...
        RunService.RenderStepped:Connect(function()
            if not isUIVisible and not OpenButton.Visible then
                OpenButton.Visible = true
            end
        end)
