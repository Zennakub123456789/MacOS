...
local function SaveConfig(fileName, data)
    ...
    if isfile(filePath) then
        ...
        print("[MacUI Config] ✏️ Updated:", filePath)
    else
        writefile(filePath, jsonString)
        print("[MacUI Config] ✨ Created:", filePath)
    end
    
    print("[MacUI Config] 💾 Data saved:", jsonString)
end
...
function MacUI:Window(config)
    ...
    local configFileName = "MacUI_Game_" .. tostring(game.PlaceId)
    self.ConfigData = LoadConfig(configFileName) or {}
    
    print("[MacUI] 🔧 Auto-Config System Enabled")
    print("[MacUI] 📁 Config File:", configFileName .. ".json")
    print("[MacUI] 📥 Loaded Config:", HttpService:JSONEncode(self.ConfigData))
    ...
    self.LoadConfigValues = function(self, loadedData)
        ...
        print("[MacUI] ✅ Config values loaded and applied to UI")
    end
    
    SaveConfig(configFileName, self.ConfigData)
    print("[MacUI] ✨ Auto-Config initialized successfully!")
